...
(function() {
  ...
  (function() {
    this.SEDROT = ['בְּרֵאשִׁית', 'נֹחַ', 'לֶךְ-לְךָ', 'וַיֵּרָא', 'חַיֵּי שָׂרָה', 'תּוֹלְדֹת', 'וַיֵּצֵא', 'וַיִּשְׁלַח', 'וַיֵּשֶׁב', 'מִקֵּץ', 'וַיִּגַּשׁ', 'וַיְחִי', 'שְׁמוֹת', 'וָאֵרָא', 'בֹּא', 'בְּשַׁלַּח', 'יִתְרוֹ', 'מִּשְׁפָּטִים', 'תְּרוּמָה', 'תְּצַוֶּה', 'כִּי תִשָּׂא', 'וַיַּקְהֵל', 'פְקוּדֵי', 'וַיִּקְרָא', 'צַו', 'שְּׁמִינִי', 'תַזְרִיעַ', 'מְּצֹרָע', 'אַחֲרֵי מוֹת', 'קְדֹשִׁים', 'אֱמֹר', 'בְּהַר', 'בְּחֻקֹּתַי', 'בְּמִדְבַּר סִינַי', 'נָשֹׂא', 'בְּהַעֲלֹתְךָ', 'שְׁלַח', 'קֹרַח', 'חֻקַּת', 'בָּלָק', 'פִּינְחָס', 'מַּטּוֹת', 'מַסְעֵי', 'דְּבָרִים', 'וָאֶתְחַנַּן', 'עֵקֶב', 'רְאֵה', 'שֹׁפְטִים', 'כִּי-תֵצֵא', 'כִּי-תָבוֹא', 'נִצָּבִים', 'וַיֵּלֶךְ', 'הַאֲזִינוּ', 'וְזֹאת הַבְּרָכָה'];
    ...
    return this.PESHUTA_SEDROT.splice(this.PESHUTA_SEDROT.indexOf('בְּהַר'), 2, 'בְּהַר-בְּחֻקֹּתַי');
  }).call(Sedra);
